...
def parse_common_args(parser):
    ...
    parser.add_argument('--val_list', type=str, default=r'F:\workspace\GHT\projects\vad\small_data\feat\val_feats.txt',
                        help='val list in train, test list path in test')
    parser.add_argument('--val_label_list', type=str, default=r'F:\workspace\GHT\projects\vad\small_data\labels'
